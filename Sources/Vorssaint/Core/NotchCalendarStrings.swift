...
extension FeatureStrings {
    static func notchCalendar(_ language: AppLanguage) -> NotchCalendarStrings {
        ...
        case .enUS: return NotchCalendarStrings(
            title: "Calendar",
            description: "Browse the month and your upcoming appointments in the notch.",
        ...
        case .ptBR: return NotchCalendarStrings(
            title: "Calendário",
            description: "Veja o mês e seus próximos compromissos no notch.",
        ...
        case .es: return NotchCalendarStrings(
            title: "Calendario",
            description: "Consulta el mes y tus próximas citas en el notch.",
        ...
        case .de: return NotchCalendarStrings(
            title: "Kalender",
            description: "Den Monat und deine nächsten Termine im Notch ansehen.",
        ...
        case .fr: return NotchCalendarStrings(
            title: "Calendrier",
            description: "Consultez le mois et vos prochains rendez-vous dans le notch.",
        ...
        case .it: return NotchCalendarStrings(
            title: "Calendario",
            description: "Consulta il mese e i prossimi appuntamenti nel notch.",
        ...
        case .ja: return NotchCalendarStrings(
            title: "カレンダー",
            description: "ノッチで月のカレンダーと今後の予定を確認できます。",
        ...
        case .ko: return NotchCalendarStrings(
            title: "캘린더",
            description: "노치에서 월별 달력과 다가오는 일정을 확인하세요.",
