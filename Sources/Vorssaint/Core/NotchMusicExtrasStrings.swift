...
extension FeatureStrings {
    static func notchMusicExtras(_ language: AppLanguage) -> NotchMusicExtrasStrings {
        ...
        case .enUS: return NotchMusicExtrasStrings(
            lyrics: "Lyrics",
            lyricsDescription: "Follow the lyrics of the current song in the notch.",
        ...
        case .ptBR: return NotchMusicExtrasStrings(
            lyrics: "Letra",
            lyricsDescription: "Acompanhe a letra da música atual no notch.",
        ...
        case .es: return NotchMusicExtrasStrings(
            lyrics: "Letra",
            lyricsDescription: "Sigue la letra de la canción actual en el notch.",
            enableLyrics: "Mostrar letra",
        ...
        case .de: return NotchMusicExtrasStrings(
            lyrics: "Liedtext",
            lyricsDescription: "Verfolge den Text des aktuellen Songs im Notch.",
        ...
        case .fr: return NotchMusicExtrasStrings(
            lyrics: "Paroles",
            lyricsDescription: "Suivez les paroles du morceau en cours dans le notch.",
        ...
        case .it: return NotchMusicExtrasStrings(
            lyrics: "Testo",
            lyricsDescription: "Segui il testo del brano attuale nel notch.",
        ...
        case .ja: return NotchMusicExtrasStrings(
            lyrics: "歌詞",
            lyricsDescription: "再生中の曲の歌詞をノッチに表示します。",
            enableLyrics: "歌詞を表示",
            online: "オンラインで歌詞を検索",
        ...
        case .ko: return NotchMusicExtrasStrings(
            lyrics: "가사",
            lyricsDescription: "현재 곡의 가사를 노치에서 확인합니다.",
            enableLyrics: "가사 표시",
            online: "온라인에서 가사 찾기",
        ...
        case .zhHans: return NotchMusicExtrasStrings(
            lyrics: "歌词",
            lyricsDescription: "在刘海中跟随当前歌曲的歌词。",
            enableLyrics: "显示歌词",
            online: "在线查找歌词",
        ...
        case .zhTW: return NotchMusicExtrasStrings(
            lyrics: "歌詞",
            lyricsDescription: "在瀏海中跟隨目前歌曲的歌詞。",
            enableLyrics: "顯示歌詞",
            online: "線上尋找歌詞",
