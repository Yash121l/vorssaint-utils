...
extension FeatureStrings {
    static func notchFiles(_ language: AppLanguage) -> NotchFilesStrings {
        ...
        case .enUS: return NotchFilesStrings(
            ...
            downloadsDescription: "See files arriving in a folder you choose, directly in the notch.",
        ...
        case .ptBR: return NotchFilesStrings(
            ...
            saved: "Salvo",
            downloadsTitle: "Downloads",
            downloadsDescription: "Veja os arquivos chegando em uma pasta escolhida, direto no notch.",
        ...
        case .es: return NotchFilesStrings(
            ...
            downloadsDescription: "Ve los archivos que llegan a una carpeta elegida, directamente en el notch.",
        ...
        case .de: return NotchFilesStrings(
            ...
            saved: "Gesichert",
            downloadsTitle: "Downloads",
            downloadsDescription: "Sieh direkt im Notch, welche Dateien in einem ausgewählten Ordner ankommen.",
        ...
        case .fr: return NotchFilesStrings(
            ...
            downloadsDescription: "Voyez les fichiers arriver dans un dossier choisi, directement dans le notch.",
        ...
        case .it: return NotchFilesStrings(
            ...
            downloadsDescription: "Vedi i file in arrivo in una cartella scelta, direttamente nel notch.",
        ...
        case .ja: return NotchFilesStrings(
            ...
            downloadsDescription: "選択したフォルダに届くファイルをノッチで確認できます。",
        ...
        case .ko: return NotchFilesStrings(
            ...
            saved: "저장됨",
            downloadsTitle: "다운로드",
            downloadsDescription: "선택한 폴더에 도착하는 파일을 노치에서 바로 확인하세요.",
        ...
        case .zhHans: return NotchFilesStrings(
            ...
            saved: "已保存",
            downloadsTitle: "下载",
            downloadsDescription: "直接在刘海中查看文件下载到所选文件夹的情况。",
        ...
        case .zhTW: return NotchFilesStrings(
            ...
            saved: "已儲存",
            downloadsTitle: "下載",
            downloadsDescription: "直接在瀏海中查看檔案下載到所選檔案夾的情況。",
        ...
        case .zhHK: return NotchFilesStrings(
            ...
            saved: "已儲存",
            downloadsTitle: "下載",
            downloadsDescription: "直接在瀏海中查看檔案下載到所選資料夾的情況。",
