...
extension FeatureStrings {
    static func notchGestures(_ language: AppLanguage) -> NotchGestureStrings {
        ...
        case .enUS: return NotchGestureStrings(
            ...
            description: "Open and close the notch with scrolling, and swipe to change tracks.",
        ...
        case .ptBR: return NotchGestureStrings(
            title: "Gestos do Notch",
            description: "Abra e feche o notch com a rolagem e deslize para trocar de música.",
        ...
        case .es: return NotchGestureStrings(
            title: "Gestos del Notch",
            description: "Abre y cierra el notch al desplazarte y desliza para cambiar de canción.",
        ...
        case .de: return NotchGestureStrings(
            title: "Notch-Gesten",
            description: "Öffne und schließe den Notch durch Scrollen und wechsle Titel durch Wischen.",
        ...
        case .fr: return NotchGestureStrings(
            title: "Gestes du Notch",
            description: "Ouvrez et fermez le notch par défilement et balayez pour changer de morceau.",
        ...
        case .it: return NotchGestureStrings(
            title: "Gesti del Notch",
            description: "Apri e chiudi il notch scorrendo e cambia brano con un gesto laterale.",
