...
extension FeatureStrings {
    static func notchNotifications(_ language: AppLanguage) -> NotchNotificationStrings {
        ...
        case .enUS: return NotchNotificationStrings(
            title: "Notifications",
            description: "New system notifications in the notch.",
            ...
            dismissSystemBannerHint: "Dismiss the original after it appears in the notch. It may still appear briefly.")
        case .ptBR: return NotchNotificationStrings(
            title: "Notificações",
            description: "Novas notificações do sistema no notch.",
            ...
            dismissSystemBannerHint: "Dispensa o aviso original após aparecer no notch. Ele ainda pode aparecer brevemente.")
        case .es: return NotchNotificationStrings(
            title: "Notificaciones",
            description: "Nuevas notificaciones del sistema en el notch.",
            ...
            dismissSystemBannerHint: "Cierra el aviso original después de aparecer en el notch. Puede verse brevemente.")
        case .de: return NotchNotificationStrings(
            title: "Mitteilungen",
            description: "Neue Systemmitteilungen im Notch.",
            ...
            dismissSystemBannerHint: "Schließt den ursprünglichen Hinweis nach der Anzeige in der Notch. Er kann kurz sichtbar sein.")
        case .fr: return NotchNotificationStrings(
            title: "Notifications",
            description: "Les nouvelles notifications système dans le notch.",
        ...
        case .it: return NotchNotificationStrings(
            title: "Notifiche",
            description: "Nuove notifiche di sistema nel notch.",
            ...
            dismissSystemBannerHint: "Chiude l’avviso originale dopo averlo mostrato nel notch. Potrebbe apparire brevemente.")
        ...
        case .ja: return NotchNotificationStrings(
            title: "通知",
            description: "新しいシステム通知をノッチに表示します。",
            ...
            dismissSystemBannerHint: "ノッチに表示した後、元の通知を閉じます。一瞬表示される場合があります。")
        case .ko: return NotchNotificationStrings(
            title: "알림",
            description: "새 시스템 알림을 노치에서 확인하세요.",
            ...
            dismissSystemBannerHint: "노치에 표시한 뒤 원래 알림을 닫습니다. 잠시 표시될 수 있습니다.")
        case .zhHans: return NotchNotificationStrings(
            title: "通知",
            description: "在刘海中查看新的系统通知。",
            ...
            dismissSystemBannerHint: "在刘海中显示后关闭原通知。原通知仍可能短暂出现。")
        case .zhTW: return NotchNotificationStrings(
            title: "通知",
            description: "在瀏海中查看新的系統通知。",
            ...
            dismissSystemBannerHint: "在瀏海中顯示後關閉原通知。原通知仍可能短暫出現。")
        case .zhHK: return NotchNotificationStrings(
            ...
            unavailable: "此通知已無法執行此操作。",
            dismissSystemBanner: "收起系統通知",
            dismissSystemBannerHint: "在瀏海顯示後關閉原通知。原通知仍可能短暫出現。")
        }
    }
}
